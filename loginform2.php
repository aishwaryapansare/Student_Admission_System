...
<h1 style=text-align:center;border-style:solid;border-color:#a84232;height:80px;border-radius:25px;font-size:50px;><b>Online  Addmission System  </b></h1>
  ...
  <form method="post" class="form-container" id="close" action="loginform2.php">
...
$res=mysql_query("select user,password from adminlogin WHERE user='$uname' AND password='$pass'");
